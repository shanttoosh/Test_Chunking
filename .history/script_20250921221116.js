...
function showQuerySectionLayer2() {
    ...
    if (configBoxes) {
        console.log('Hiding config boxes');
        configBoxes.style.display = 'none';
    } else {
        console.log('Config boxes not found');
    }
    
    // Show the query section
    const querySection = document.getElementById('query-section-layer2');
    if (querySection) {
        console.log('Showing query section');
        querySection.style.display = 'block';
        // Trigger popup animation
        setTimeout(() => {
...
function showConfigBoxesLayer2() {
    console.log('showConfigBoxesLayer2 called');
    ...
    // Show the 4 configuration boxes
    const configBoxes = document.querySelector('#content-layer-2 .config-grid');
    if (configBoxes) {
        console.log('Showing config boxes');
...
function performQueryLayer2() {
    ...
    // Generate mock results for Layer 2 (exactly 3 results)
    const mockResults = [
        {
