                  ...
                  <div className="config-grid">
                    <div className="config-card">
                      <div className="config-card-header">
                        ...
                        <div className="config-title">Preprocessing</div>
                      </div>
                      <div className="capability-list">
                        <div className="capability-item active">
                          <div className="capability-icon">📊</div>
                          <div className="capability-text">Data & AI</div>
                        </div>
                        <div className="capability-item">
                          <div className="capability-icon">⚙️</div>
                          <div className="capability-text">Digital Engineering</div>
                        </div>
                        <div className="capability-item">
                          <div className="capability-icon">📢</div>
                          <div className="capability-text">Digital Marketing</div>
                        </div>
                        <div className="capability-item">
                          <div className="capability-icon">⭐</div>
                          <div className="capability-text">Digital Experience</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="config-card">
                      <div className="config-card-header">
                        ...
                        <div className="config-title">Chunking</div>
                      </div>
                      <div className="capability-list">
                        <div className="capability-item active">
                          <div className="capability-icon">🧠</div>
                        ...
                        <div className="capability-item">
                          <div className="capability-icon">🔄</div>
                          <div className="capability-text">Recursive Splitter</div>
                        </div>
                        <div className="capability-item">
                          <div className="capability-icon">📄</div>
                    ...
                    <div className="config-card">
                      <div className="config-card-header">
                        <div className="config-icon">🧠</div>
                        <div className="config-title">Embedding</div>
                      </div>
                      <div className="capability-list">
                        <div className="capability-item active">
                          <div className="capability-icon">🤖</div>
                          <div className="capability-text">OpenAI Large</div>
                        </div>
                        <div className="capability-item">
                          <div className="capability-icon">⚡</div>
                          <div className="capability-text">OpenAI Small</div>
                        </div>
                        <div className="capability-item">
                          <div className="capability-icon">🔬</div>
                        ...
                        <div className="capability-item">
                          <div className="capability-icon">🌐</div>
                          <div className="capability-text">Cohere Embed</div>
                        </div>
                      </div>
                    </div>
