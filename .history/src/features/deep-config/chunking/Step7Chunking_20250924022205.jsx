      ...
      <div className="chunking-methods">
        <div className="method-selection">
          ...
          <div className="method-cards">
            <div className={`method-card ${selectedChunkingMethod === 'fixed' ? 'selected' : ''}`}>
              <input 
                type="radio" 
              ...
              <div className="method-content">
                ...
                <p>Split data into fixed-size chunks with optional overlap</p>
              </div>
            </div>
            <div className={`method-card ${selectedChunkingMethod === 'recursive' ? 'selected' : ''}`}>
              <input 
                type="radio" 
                name="chunking-method" 
                value="recursive" 
            ...
            <div className={`method-card ${selectedChunkingMethod === 'semantic' ? 'selected' : ''}`}>
              <input 
                type="radio" 
                name="chunking-method" 
                value="semantic" 
              ...
              <div className="method-content">
                ...
                <p>AI-powered semantic chunking using embeddings</p>
              </div>
            </div>
            <div className={`method-card ${selectedChunkingMethod === 'document' ? 'selected' : ''}`}>
              <input 
                type="radio" 
                name="chunking-method" 
                value="document" 
              ...
              />
              <div className="method-content">
                <h5>Document Based Chunking</h5>
                <p>Group rows by key column and split by token count</p>
              </div>
            </div>
          </div>
        </div>
