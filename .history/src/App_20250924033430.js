...
function App() {
  ...
  const searchChromaDB = async (query, topK) => {
    ...
    await runStepTimer('retrieval', 'Searching Vector Database', 2000);
    const mockResults = [
      {
        id: '1',
            ...
            <div className="deep-config-container">
              ...
              {deepConfigStep === 0 && (
                <Step0Preview
                  ...
                  onNext={async () => { 
                    await runStepTimer('analyze', 'Running Data Analysis', 2000);
                    setDeepConfigStep(1); 
                    scrollToNextStep(1); 
                  }}
                />
  ...
  "semantic_coherence": "High"
        ...
        {/* Layer 3 Query Section */}
        {currentLayer === 3 && showQuerySectionLayer3 && (
          <div className="query-section show">
            <div className="query-header">
              <h3>🔍 Test Retrieval</h3>
              <button 
                className="close-btn" 
                onClick={() => setShowQuerySectionLayer3(false)}
              >
                ×
              </button>
            </div>
            <QueryBar value={query} onChange={setQuery} onSubmit={performQueryLayer3} />
            <div className="query-results">
