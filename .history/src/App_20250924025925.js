...
function App() {
  ...
  // Layer 3 Deep Config step timer - only for main steps
  ...
  // Update preprocessing substep text
  const updatePreprocessingStep = (stepText) => {
    updateStepStatus('preprocess', 'active', '', stepText, 0);
  };
  ...
  const startChunkingProcess = async () => {
    ...
    updateStepStatus('preprocess', 'completed', 'Completed', '', 0);
    // Start chunking timer
    await runStepTimer('chunking', 'Starting Chunking Process', 3000);
    setDeepConfigStep(7);
    scrollToNextStep(7);
  };
  ...
  const storeEmbeddings = async (backend, collection) => {
    // Mock embedding storage
    console.log(`Storing embeddings in ${backend}`, collection);
    await runStepTimer('storage', 'Storing in Vector Database', 3000);
  ...
  const searchChromaDB = async (query, topK) => {
    ...
    updateStepStatus('storage', 'completed', 'Completed', '', 0);
            ...
            <div className="deep-config-container">
              ...
              {deepConfigStep === 0 && (
                <Step0Preview
                  ...
                  onNext={() => { 
                    updatePreprocessingStep('Running Data Analysis');
                    setDeepConfigStep(1); 
                    scrollToNextStep(1); 
                  }}
                />
              ...
              {deepConfigStep === 1 && (
                <Step1DefaultPreprocess onNext={() => { 
                  updatePreprocessingStep('Applying Default Preprocessing');
                ...
                <div className="config-step" data-step="2">
                  ...
                  <div className="step-actions">
                    ...
                    <button 
                      ...
                      onClick={() => {
                        updatePreprocessingStep('Applying Type Conversion');
                        setDeepConfigStep(3);
                        scrollToNextStep(3);
                      }}
                    >
                  ...
                  <div className="step-actions">
                    ...
                    <button 
                      ...
                      onClick={() => {
                        ...
                        updatePreprocessingStep('Applying Null Handling');
                        setDeepConfigStep(4);
                      }}
                    >
                      Apply Null Handling
                ...
                <div className="config-step" data-step="4">
                  ...
                  <div className="step-actions">
                    ...
                    <button 
                      className="btn btn-primary" 
                      onClick={() => {
                        updatePreprocessingStep('Applying Duplicate Handling');
                  ...
                  <div className="step-actions">
                    ...
                    <button 
                      ...
                      onClick={() => {
                        ...
                        updatePreprocessingStep('Applying Text Processing');
                  ...
                  <div className="step-actions">
                    ...
                    <button 
                      ...
                      onClick={async () => {
                        ...
                        updateStepStatus('chunking', 'completed', 'Completed', '', 0);
                  ...
                  <div className="step-actions">
                    ...
                    <button 
                      ...
                      onClick={async () => {
                        ...
                        updateStepStatus('embedding', 'completed', 'Completed', '', 0);
                        await storeEmbeddings('ChromaDB', collectionName);
                      }}
                    >
                      Store in ChromaDB
                    </button>
