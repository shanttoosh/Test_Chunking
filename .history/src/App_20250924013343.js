...
import { LivePreviewPanel, Step0Preview, Step1DefaultPreprocess, Step7Chunking, Step9Embedding, Step11Storage, Step12Retrieval } from './features/deep-config';
            ...
            <div className="deep-config-container">
              ...
              {deepConfigStep === 7 && (
                <Step7Chunking
                  ...
                  onApply={() => { setChunkingResult({ method: selectedChunkingMethod, totalChunks: 45 }); setDeepConfigStep(8); }}
                />
              )}
  ...
  "semantic_coherence": "High"
              ...
              {deepConfigStep === 9 && (
                <Step9Embedding
                  ...
                  onNext={() => { setEmbeddingResult({ model: embeddingModelChoice, dimensions: 384, processingTime: 12.5 }); setDeepConfigStep(10); }}
                />
              )}
              ...
              {deepConfigStep === 11 && (
                <Step11Storage
                  ...
                  onOpenRetrieval={() => setShowRetrievalPopup(true)}
                />
              )}
