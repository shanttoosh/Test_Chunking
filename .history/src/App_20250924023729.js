  ...
  "semantic_coherence": "High"
              ...
              {deepConfigStep === 9 && (
                <Step9Embedding
                  ...
                  onNext={() => { setEmbeddingResult({ model_used: embeddingModelChoice, vector_dimension: 384, processing_time: 12.5, total_chunks: 45, embedded_chunks: [] }); setDeepConfigStep(9.5); }}
                />
              )}
