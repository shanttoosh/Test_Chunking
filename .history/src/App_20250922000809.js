                  ...
                  <div className="type-conversion-grid">
                    <div className="conversion-item">
                      <div className="column-info">
                        <h4>column_1</h4>
                        <span className="current-type">Current: object</span>
                      </div>
                      <select className="form-control">
                    ...
                    <div className="conversion-item">
                      <div className="column-info">
                        <h4>column_2</h4>
                        <span className="current-type">Current: float64</span>
                      </div>
                      <select className="form-control">
                        <option value="no-change">No change</option>
                        <option value="text">Text</option>
                ...
                <div className="config-step">
                  ...
                  <div className="null-handling-options">
                    ...
                    <div className="form-group">
                      ...
                      <select className="form-control">
                        <option value="column_2">column_2 (5 nulls)</option>
                      </select>
                    </div>
                ...
                <div className="config-step">
                  ...
                  <div className="duplicate-info">
                    <div className="info-card">
                      ...
                      <p>No duplicate rows detected in your dataset.</p>
                    </div>
                  </div>
