...
const uploadAndProcessCSV = async (file, layer = 1) => {
  const formData = new FormData();
  formData.append('file', file);
  
  const apiUrl = layer === 1 ? API_CONFIG.layer1 : 
                 layer === 2 ? API_CONFIG.layer2 : API_CONFIG.layer3;
...
const searchAPI = async (query, layer = 1, nResults = 5) => {
  const apiUrl = layer === 1 ? API_CONFIG.layer1 : 
                 layer === 2 ? API_CONFIG.layer2 : API_CONFIG.layer3;
  
  const collectionName = layer === 1 ? 'fast_mode_chunks' : 
                        layer === 2 ? 'config_mode_chunks' : 'deep_config_chunks';
        ...
        <div className="sidebar show">
          ...
          <div className="stats-grid">
            <div className="stat-card">
              <div className="stat-value">{processingStats.totalChunks}</div>
              <div className="stat-label">Total Chunks</div>
            </div>
            <div className="stat-card">
              <div className="stat-value">{processingStats.processTime}s</div>
            ...
            <div className="stat-card">
              <div className="stat-value">{processingStats.memoryUsage}MB</div>
                  ...
                  {showQuerySection && (
                    <div className="query-section show">
                      <div className="query-bar">
                        ...
                        />
                        <div className="query-icon" onClick={performQuery}>
